...
export const services = [
  { id: "svc-proxy", name: "Proxy Gateway", node: "HK Edge 01", nodeId: "hk-edge-01", protocol: "HTTPS", latency: 21, status: "online" },
  { id: "svc-api", name: "API Core", node: "Tokyo App 02", nodeId: "tyo-app-02", protocol: "HTTP", latency: 84, status: "warning" },
  { id: "svc-postgres", name: "Postgres", node: "Frankfurt DB 01", nodeId: "fra-db-01", protocol: "TCP", latency: 46, status: "online" },
  { id: "svc-jobs", name: "Media Jobs", node: "San Jose Worker 03", nodeId: "sjc-worker-03", protocol: "Queue", latency: 68, status: "online" },
  { id: "svc-redis", name: "Redis Cache", node: "Singapore Cache 01", nodeId: "sg-cache-01", protocol: "TCP", latency: 0, status: "offline" }
];
